...
-file("src/gleam/float.gleam", 194).
...
-file("src/gleam/float.gleam", 179).
...
-file("src/gleam/float.gleam", 102).
...
-file("src/gleam/float.gleam", 309).
...
-file("src/gleam/float.gleam", 162).
...
-file("src/gleam/float.gleam", 212).
...
-file("src/gleam/float.gleam", 225).
...
-file("src/gleam/float.gleam", 384).
...
-file("src/gleam/float.gleam", 262).
...
-file("src/gleam/float.gleam", 279).
...
-file("src/gleam/float.gleam", 341).
...
-file("src/gleam/float.gleam", 372).
...
-file("src/gleam/float.gleam", 400).
...
-file("src/gleam/float.gleam", 396).
...
-file("src/gleam/float.gleam", 419).
...
-file("src/gleam/float.gleam", 415).
...
-file("src/gleam/float.gleam", 442).
-spec random() -> float().
...
-file("src/gleam/float.gleam", 469).
...
-file("src/gleam/float.gleam", 488).
...
-file("src/gleam/float.gleam", 516).
...
-file("src/gleam/float.gleam", 570).
...
-file("src/gleam/float.gleam", 595).
...
-file("src/gleam/float.gleam", 632).
