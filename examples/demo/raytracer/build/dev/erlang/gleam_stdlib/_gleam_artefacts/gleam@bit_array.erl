...
-file("src/gleam/bit_array.gleam", 15).
...
-file("src/gleam/bit_array.gleam", 22).
...
-file("src/gleam/bit_array.gleam", 33).
...
-file("src/gleam/bit_array.gleam", 70).
...
-file("src/gleam/bit_array.gleam", 78).
...
-file("src/gleam/bit_array.gleam", 114).
...
-file("src/gleam/bit_array.gleam", 154).
...
-file("src/gleam/bit_array.gleam", 173).
...
-file("src/gleam/bit_array.gleam", 198).
...
-file("src/gleam/bit_array.gleam", 205).
...
-file("src/gleam/bit_array.gleam", 226).
...
-file("src/gleam/bit_array.gleam", 222).
...
-file("src/gleam/bit_array.gleam", 268).
...
-file("src/gleam/bit_array.gleam", 309).
